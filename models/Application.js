...
model.schema['formProperties'] = {
  ...
  'gender' : {label:"Gender", formType:"radioGroup", student:true, mentor:true, values: ["Male", "Female"]},
  'genderPref' : {label:"Preferred Gender of Mentor", formType:"radioGroup", student:true, mentor:true, values: ["Male", "Female"]},
